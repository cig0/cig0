...
At CodigoCode, built the Azure infrastructure behind our AI SaaS from scratch. IaC-first, automated end-to-end. Among other features, I implemented GitOps so deployments, changes, and rollbacks are consistent and boring.
